        ...
        for i in 0 ..< 3 {
            ...
            if showsGridMinor {
                for j in 1 ..< 3 {
                    ...
                    UIRectFill(CGRect(x: 1.0, y: CGFloat(height) - borderPadding * 2.0, width: CGFloat((width / 9.0) * CGFloat(j) + CGFloat(width / 3.0) * CGFloat(i)), height: borderPadding))
                    UIRectFill(CGRect(x: CGFloat(width) - borderPadding * 2.0, y: 1.0, width: borderPadding, height: CGFloat((height / 9.0) * CGFloat(j) + CGFloat(height / 3.0) * CGFloat(i))))
                }
            }
            ...
            if showsGridMajor {
                if i > 0 {
                    UIColor.white.set()
                    UIRectFill(CGRect(x: 1.0, y: CGFloat(height) - borderPadding * 2.0, width: CGFloat(CGFloat(i) * width / 3.0), height: borderPadding))
                    UIRectFill(CGRect(x: CGFloat(width) - borderPadding * 2.0, y: 1.0, width: borderPadding, height: CGFloat(CGFloat(i) * height / 3.0)))
                }
            }
        }
    }
